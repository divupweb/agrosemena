...
$_['text_checkout_account']          = 'Реквизиты покупателя';
$_['text_checkout_payment_address']  = 'Реквизиты покупателя';
...
$_['text_your_details']              = 'Получатель заказа';
$_['text_your_address']              = 'Адрес доставки заказа';
...
$_['entry_email']                    = 'E-Mail  (для уточнения деталей доставки Вашего заказа):';
...
$_['entry_city']                     = 'Почтовый индекс, населённый пункт:';
