...
$_['text_new_greeting']         = 'Благодарим за интерес к товарам %sа Agrosemena.ru. Ваш заказ получен, в ближайшее время мы свяжемся с вами для уточнения деталей оплаты и доставки.';
...
$_['text_new_payment_method']   = 'Способы оплаты:';
...
$_['text_new_powered']			= '© 2010 - 2017 Agrosemena.RU - семена для высокого урожая. Реализация семян кормовой свеклы, овощей и цветов.';
