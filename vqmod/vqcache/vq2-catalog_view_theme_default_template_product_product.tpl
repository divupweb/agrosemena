        ...
        <div>
          ...
          &nbsp;
                          ...
                          <?php if (!$product_quantity && $waitlist_enabled) { ?>
                            <div class="waitlist-not-available" style="float:left; padding-right:15px;"><?php echo $text_not_available;?></div>
                            <div class="waitlist-add" style="float:left; padding-right:15px;">
